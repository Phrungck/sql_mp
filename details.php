            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="edit.php" class="btn btn-success pull-right">Edit Details</a>
                    </div>
                    ...
                    $sql = "SELECT id, or_no,family_name,first_name,middle_name,husband_surname,address,date_of_birth,place_of_birth,civil_status,purpose,gender,dst_paid,max(booking_date) FROM receipt join users using (id) natural join nbi where users.username = '$username'";
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            $_SESSION["or_no"] = $row['or_no'];
                            $_SESSION["family_name"] = $row['family_name'];
                            $_SESSION["first_name"] = $row['first_name'];
                            $_SESSION["middle_name"] = $row['middle_name'];
                            $_SESSION["husband_surname"] = $row['husband_surname'];
                            ...
                            $_SESSION["dst_paid"] = $row['dst_paid'];
